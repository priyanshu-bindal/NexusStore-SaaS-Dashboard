    ...
    return (
        <div className="relative flex-1 max-w-md">
            <div className="relative">
                ...
                <input
                    className="w-full bg-slate-100 border-none rounded-full py-2 pl-10 pr-10 text-sm focus:ring-2 focus:ring-amber-600/20 focus:bg-white transition-all outline-none"
