            ...
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200">
                ...
                <form onSubmit={handleSubmit(onSubmit as any)} className="p-6 space-y-4">
                    <div className="space-y-1">
                        ...
                        <input
                            {...register("name")}
                            className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-sm focus:ring-2 focus:ring-[#d97706] focus:border-[#d97706] outline-none transition-all"
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1">
                            ...
                            <input
                                ...
                                type="number"
                                step="0.01"
                                className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-sm focus:ring-2 focus:ring-[#d97706] outline-none transition-all"
                            />
                    ...
                    <div className="space-y-1">
                        ...
                        <textarea
                            ...
                            rows={3}
                            className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-sm focus:ring-2 focus:ring-[#d97706] outline-none transition-all resize-none"
                    ...
                    <div className="pt-2 flex items-center justify-end gap-3">
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="px-4 py-2 bg-[#d97706] hover:bg-amber-600 text-white text-sm font-bold rounded-lg shadow-sm flex items-center gap-2 disabled:opacity-70 transition-all"
                        >
