    ...
    return (
        <>
            <button
                ...
                className="bg-[#10b981] text-white px-6 py-2.5 rounded-full font-bold text-sm shadow-[0_4px_14px_0_rgba(16,185,129,0.39)] hover:shadow-[0_6px_20px_rgba(16,185,129,0.23)] hover:bg-[#059669] transition-all flex items-center gap-2"
            >
                <Plus size={18} />
                Add Product
            </button>
