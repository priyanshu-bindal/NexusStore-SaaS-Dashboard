            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
                <div className="space-y-1">
                    <div className="flex items-center gap-3">
                        <LoaderLink href="/orders" className="p-2 -ml-2 text-slate-400 hover:text-slate-600 transition-colors">
                            <ChevronLeft size={24} />
                        </LoaderLink>
                            ...
                            {timeline.map((step, idx) => (
                                <div key={idx} className={cn("relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group", step.active && "is-active")}>
                                    <div className={cn(
                                        ...
                                        step.active ? "bg-[#d97706] text-white" : "bg-slate-200 text-slate-500"
                                    )}>
                                        <step.icon size={16} />
                                    </div>
                                    <div className={cn(
                                        ...
                                        <div className="flex items-center justify-between space-x-2 mb-1">
                                            ...
                                            {step.date && <time className={cn("text-xs font-medium", step.active ? "text-[#d97706]" : "text-slate-400")}>{step.date}</time>}
                                        </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <button className="text-[#d97706] hover:text-amber-600 transition-colors">
                                <Edit size={18} />
                            </button>
                        </div>
