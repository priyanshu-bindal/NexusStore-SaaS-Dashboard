        ...
        <>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input id="flatRate" type="number" step="0.01" min="0"
                                ...
                                className="w-full pl-7 pr-3 py-2 text-sm text-slate-900 border border-slate-200 rounded-lg bg-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-shadow"
                            />
                        </div>
                ...
                <div className="flex items-center gap-3 p-4 bg-blue-50 border border-blue-100 rounded-lg mb-8">
                    ...
                    <p className="text-sm text-amber-700">These settings apply store-wide. You can override shipping on individual products.</p>
                </div>
